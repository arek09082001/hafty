...
export const DE = {
  ...
  "garne.listeLeer":
    "In der Garnliste steht noch nichts. Die Garnfarben werden einmalig mit dem Importskript eingelesen; solange das nicht geschehen ist, rechnet die App mit den Farben aus Ihrem Bild statt mit Herstellergarnen.",
  "garne.antippenText":
...
export const PL: Record<Textschluessel, string> = {
  ...
  "garne.listeLeer":
    "Na liście nici nie ma jeszcze nic. Kolory nici wczytuje się raz skryptem importującym; dopóki to nie nastąpi, program liczy kolorami ze zdjęcia zamiast nićmi producenta.",
  "garne.antippenText":
